...
//        $this->dumpSettings['exclude-tables'] = array('countries', 'states', 'cities');
//        //me end
...
//        flash(translate('Error ') . translate('Error Code:') . $this->dbType.'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')->error();
//       flash(translate('Error ') . translate('this->dsn:') . $this->dsn)->error();
//       flash(translate('Error ') . translate('this->user:') . $this->user)->error();
//       flash(translate('Error ') . translate('this->pass:') . $this->pass)->error();
//       flash(translate('Error ') . translate('this->pdoSettings:') . $this->pdoSettings)->error();
